 ...
 */
statusRouter.get("/", auth_middleware_1.authUserMiddleWare, function (req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        var connection, statusService, limit, offset, status_1, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connection = _a.sent();
                    statusService = new impl_1.StatusServiceImpl(connection);
                    ...
                    return [4 /*yield*/, statusService.getAllStatus({
                            limit: limit,
                            offset: offset
                        })];
                case 2:
