 ...
 */
listRouter.post("/add", authUserMiddleWare, async function (req, res) {
 ...
 * Nécessite d'être connecté : OUI
 */
listRouter.get("/", authUserMiddleWare, async function (req, res) {
    //vérification droits d'accès
    if (await isDevConnected(req)) {
        const connection = await DatabaseUtils.getConnection();
        const listService = new ListServiceImpl(connection);
 ...
 * Nécessite d'être connecté : OUI
 */
listRouter.get("/:id", authUserMiddleWare, async function (req, res) {
    //vérification droits d'accès
    if (await isDevConnected(req)) {
        const connection = await DatabaseUtils.getConnection();
        const listService = new ListServiceImpl(connection);
 ...
 * Nécessite d'être connecté : OUI
 */
listRouter.delete("/:id", authUserMiddleWare, async function (req, res) {
    //vérification droits d'accès
    if (await isDevConnected(req)) {
        const connection = await DatabaseUtils.getConnection();
        const listService = new ListServiceImpl(connection);
