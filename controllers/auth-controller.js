...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.createUser = function (properties) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.connection.execute("INSERT INTO ".concat(user_controller_1.UserController.userTable, " (user_mail, user_password, user_name, user_firstname,\n                                                             user_phone_number, user_type_id)\n                                           VALUES (?, ?, ?, ?, ?, ?)"), [
                                properties.userMail,
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.userController.getUserByMail(properties.userMail)];
                    case 2: 
                    ...
                    case 3:
                        err_1 = _a.sent();
                        console.error(err_1);
                        return [2 /*return*/, new models_1.LogError({ numError: 500, text: "Error during creation" })];
