...
var UserTypeController = /** @class */ (function () {
    function UserTypeController(connection) {
     ...
     * @param userTypeId
     */
    UserTypeController.prototype.getUserTypeById = function (userTypeId) {
        return __awaiter(this, void 0, void 0, function () {
            var res, data, rows, row;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connection.query("SELECT user_type_id,\n                                                        user_type_libelle\n                                                 FROM USER_TYPE\n                                                 where user_type_id = ?", [
                            userTypeId
                        ])];
                    case 1:
                        res = _a.sent();
                        ...
                        if (Array.isArray(data)) {
                            ...
                            if (rows.length > 0) {
                                row = rows[0];
                                return [2 /*return*/, new models_1.UserTypeModel({
     ...
     * @param options
     */
    UserTypeController.prototype.getUserTypes = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.connection.query("SELECT user_type_id,\n                                                        user_type_libelle\n                                                 FROM USER_TYPE\n                                                 LIMIT ?, ?", [
                                offset,
                                limit
                            ])];
                    case 1:
