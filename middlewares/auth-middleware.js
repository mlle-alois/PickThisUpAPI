        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if (!(0, Utils_1.isTokenExpired)(session, 2)) return [3 /*break*/, 4];
                    return [4 /*yield*/, sessionController.deleteSessionByToken(token)];
                case 3:
                    // Si oui DELETE
                    if (_a.sent()) {
                    ...
                    _a.label = 4;
                case 4: return [4 /*yield*/, sessionController.updateHourOfSession(session)];
                case 5:
                    _a.sent();
                    next();
                    return [2 /*return*/];
