...
var UserTypeServiceImpl = /** @class */ (function () {
    function UserTypeServiceImpl(connection) {
     ...
     * @param userTypeId
     */
    UserTypeServiceImpl.prototype.getUserTypeById = function (userTypeId) {
     ...
     */
    UserTypeServiceImpl.prototype.getAllUsersTypes = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userTypeController.getUserTypes(options)];
            });
        });
    };
