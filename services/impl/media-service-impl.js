...
var MediaServiceImpl = /** @class */ (function () {
    function MediaServiceImpl(connection) {
     ...
     * @param options
     */
    MediaServiceImpl.prototype.createMedia = function (options) {
     ...
     * @param mediaId
     */
    MediaServiceImpl.prototype.getMediaById = function (mediaId) {
        return this.mediaController.getMediaById(mediaId);
    };
    /**
     * Récupération de l'id de media maximum existant
     */
    MediaServiceImpl.prototype.getMaxMediaId = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.mediaController.getMaxMediaId()];
            });
        });
    };
    /**
     ...
     * @param mediaId
     */
    MediaServiceImpl.prototype.deleteMedia = function (mediaId) {
        return __awaiter(this, void 0, void 0, function () {
            var media;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getMediaById(mediaId)];
                    case 1:
                        media = _a.sent();
                        if (media instanceof models_1.LogError)
                            return [2 /*return*/, false];
                        return [2 /*return*/, this.mediaController.deleteMedia(mediaId)];
                }
            });
        });
    };
